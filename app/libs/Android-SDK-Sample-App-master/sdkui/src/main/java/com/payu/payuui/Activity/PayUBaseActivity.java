...
//            ((TextView) findViewById(R.id.txt_amount)).setText(SdkUIConstants.RUPEE + ": " + mPaymentParams.getAmount());
//            ((TextView) findViewById(R.id.txt_plan_name)).setText(getIntent().getStringExtra("txt_plan_name"));
                ...
                switch (paymentOptionsList.get(position)) {
                    case SdkUIConstants.SAVED_CARDS:
                        ...
                        if (savedCards != null) {
                            ...
                            if (savedCards.get(currentPosition).getEnableOneClickPayment() == 1
                                    && savedCards.get(currentPosition).getOneTapCard() == 1) {
                                payNowButton.setEnabled(true);
